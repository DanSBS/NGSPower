...
load("output/powerSimWeak.RData")
...
diffs10 <- lapply(powerSimWeak, function(u){
...
diffs30 <- lapply(powerSimWeak, function(u){
...
diffs100 <- lapply(powerSimWeak, function(u){
...
diffs200 <- lapply(powerSimWeak, function(u){
