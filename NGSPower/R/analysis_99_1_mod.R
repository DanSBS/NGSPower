...
diffs10 <- lapply(powerSimMed, function(u){
...
diffs30 <- lapply(powerSimMed, function(u){
...
diffs100 <- lapply(powerSimMed, function(u){
...
diffs200 <- lapply(powerSimMed, function(u){
