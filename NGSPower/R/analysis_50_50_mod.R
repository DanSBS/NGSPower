...
load("output/powerSim5050Med.RData")
...
diffs10 <- lapply(powerSim5050Med, function(u){
...
diffs30 <- lapply(powerSim5050Med, function(u){
...
diffs100 <- lapply(powerSim5050Med, function(u){
...
diffs200 <- lapply(powerSim5050Med, function(u){
